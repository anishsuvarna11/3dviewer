...
var import_react2, import_hoist_non_react_statics2, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Noop3, ClassNames, isBrowser2, isJest, globalContext, globalKey;
...
var import_react5, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Noop5, createStyled, emotion_styled_base_browser_esm_default;
    ...
    createStyled = function createStyled2(tag, options) {
      ...
      return function() {
        ...
        var Styled = withEmotionCache(function(props, cache2, ref) {
          ...
          newProps.className = className;
          newProps.ref = ref;
          var ele = (0, import_react5.createElement)(finalTag, newProps);
          var possiblyStyleElement = (0, import_react5.createElement)(Noop5, null);
          return (0, import_react5.createElement)(import_react5.Fragment, null, possiblyStyleElement, ele);
        });
...
var init_ThemeContext = __esm({
  "node_modules/@mui/private-theming/useTheme/ThemeContext.js"() {
    ...
    ThemeContext2 = React11.createContext(null);
    if (true) {
...
var React13, import_prop_types8, import_jsx_runtime3, ThemeProvider_default;
...
var React14, import_prop_types9, import_jsx_runtime4, _excluded4;
...
var React15, import_prop_types10, import_jsx_runtime5, ThemeProvider_default2;
...
function createGetCssVar(prefix2 = "") {
  function appendVar(...vars) {
    ...
    return `, var(--${prefix2 ? `${prefix2}-` : ""}${vars[0]}${appendVar(...vars.slice(1))})`;
  }
    ...
    if (typeof val === "string" || typeof val === "number") {
      ...
      if (typeof value === "string" && value.startsWith("var")) {
        if (!basePrefix && prefix2) {
          value = value.replace(/var\(--/g, `var(--${prefix2}-`);
        } else {
          value = prefix2 ? value.replace(new RegExp(basePrefix, "g"), prefix2) : value.replace(new RegExp(`${basePrefix}-`, "g"), "");
        }
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const clonedBaseTheme = React18.useMemo(() => JSON.parse(JSON.stringify(baseTheme)), []);
    const {
      colorSchemes: baseColorSchemes = {}
    } = clonedBaseTheme, restBaseTheme = _objectWithoutPropertiesLoose(clonedBaseTheme, _excluded7);
    const {
...
var React18, import_prop_types11, import_jsx_runtime7, import_jsx_runtime8, _excluded7, _excluded23, _excluded33, DISABLE_CSS_TRANSITION;
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-EMRYIYLW.js.map
